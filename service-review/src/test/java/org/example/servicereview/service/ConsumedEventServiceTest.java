...
class ConsumedEventServiceTest {
    private static final String EVENT_ID = "review:judge:1";
    private static final String ROUTING_KEY = "reviews.judge.record.routing";
    ...
    @Test
    void recordFailureIncrementsRetryCountAtomicallyAndKeepsError() {
