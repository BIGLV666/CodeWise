...
public class ReviewConfigDto {
     ...
     */
    private Integer enableAutoReview ;
     ...
     */
    private Integer countCompileError ;

    /**
     * 最低难度因子 EF。
     * SM-2 官方常用下限为 1.3，防止题目因多次失败导致间隔增长能力过低。
     */
    private java.math.BigDecimal minEasinessFactor ;

    /**
     * 初始难度因子 EF。
     * 新加入复习计划的题目默认使用 2.5，后续根据 quality 动态调整。
     */
    private java.math.BigDecimal initialEasinessFactor ;
     ...
     */
    private Integer masteredIntervalDays ;
