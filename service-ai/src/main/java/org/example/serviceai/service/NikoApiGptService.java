    ...
    public void streamAi(String prompt, Consumer<String> onChunk)

     {
        try {
            ...
            body.put("model", nikoApiGpt.getModel());
            ...
            URL url = new URL("https://nikoapi.xyz/v1/chat/completions");
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setRequestProperty("Authorization", "Bearer " + nikoApiGpt.getApikey());
