-- 事务性 Outbox 事件表（Question -> Judge 主链路消息可靠性）
-- 库：codewise_question（service-question 与 service-judge 共库，两侧写入同一张表）
...
CREATE TABLE IF NOT EXISTS event_outbox (
  ...
  event_type VARCHAR(64) NOT NULL COMMENT '事件类型，如 JUDGE_SUBMIT_REQUEST',
